                        ...
                        <div class="product-details">
                            ...
                            <div class="form-group">
                                ...
                                <div style="display: flex;">
                                    <?= form_input($diskon) ?>
                                    <?= form_input($cekdiskon) ?>
                                </div>
                                <span id="total_diskon"></span>
                            </div>
                            <div class="pd-share">
...
<script>
    $('document').ready(function() {
        ...
        $("#cekdiskon").on("click", function() {
            var kode_voucher = $('#diskon').val();
            var total_harga = $('#total_harga').val();
            $.ajax({
                url: "<?= site_url('shop/cekvoucher') ?>",
                type: 'GET',
                data: {
                    'diskon': kode_voucher,
                },
                dataType: 'json',
                success: function(data) {
                    var diskon = data[0].besar_diskon
                    var total_diskon = total_harga * diskon / 100
                    var total_semua = total_harga - total_diskon
