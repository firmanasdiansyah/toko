...
class Shop extends BaseController
{
	...
	private $apiKey = "2a9c897049ccbb76d062ce649991968b";
	...
	public function getVoucherDiskon()
	{
		if ($this->request->isAJAX()) {
			$voucherModel = new \App\Models\VoucherModel();
			$data = $this->request->getGet('diskon');
			$voucher = $voucherModel->select('diskon.*')->where('Kode_voucher', $data)->findAll();
